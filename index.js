...
for (let n = 0; n <= arraySizes.length; n++) {
  ...
  //Declare runs and Bubble Sort variables to calculate average runtimes (commented for Bubble Sort and repeated for each sort algorithm.)
  const runs = 10;
  let bubbleTotal = 0;
  let bubbleAverage = 0;
  ...
  let data =
    ...
    "\n";
  console.log(data);
  //Write runbtime data to csv file
